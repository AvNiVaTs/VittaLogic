...
// Mock data
const mockVendorTypes = ["Office Supplies", "Technology", "Services", "Manufacturing", "Consulting", "Utilities"]
...
const mockLiabilities = [
  ...
  { id: "LIB-002", type: "Bank Loan", name: "Equipment Loan - SBI", amount: 250000 },
  ...
  { id: "LIB-005", type: "Vendor Payable", name: "Office Supplies Payable", amount: 25000 },
  { id: "LIB-006", type: "Vendor Payable", name: "IT Services Payable", amount: 85000 },
...
const liabilityTypes = ["Bank Loan", "Credit Card", "Vendor Payable", "Tax Liability", "Other Liability"]
...
const mockCustomerTypes = ["Corporate", "Individual", "Government", "Non-Profit", "SME", "Enterprise"]
...
function PurchaseTab() {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.referenceType === "Asset" && formData.assetName && formData.quantity) {
      ...
      // Get existing entered assets from localStorage
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {formData.referenceType === "Liability" && (
          <>
            ...
            {formData.liabilityId && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="liabilityName">Liability Name</Label>
                  <Input id="liabilityName" value={formData.liabilityName} disabled className="bg-gray-50" />
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({ ...prev, liabilityAmount: e.target.value, amount: e.target.value }))
                      }
                      className="pl-8"
                      placeholder="0.00"
                      required
...
export default function TransactionPage() {
  ...
  const handleSaveEdit = () => {
    ...
    console.log("Transaction updated successfully!", editingTransaction)
  }
