...
// Mock approval history data for department budget approvals
const mockApprovalHistory = [
  ...
  },
  {
    approvalId: "APR007",
    approvalFor: "department_budget",
    reason: "IT infrastructure upgrade budget for H1 2024",
    priority: "high",
    expenseRange: "300000 - 400000",
    ...
    actionNote: "Approved for critical infrastructure upgrades. Essential for business continuity.",
  ...
  },
  {
    approvalId: "APR008",
    approvalFor: "department_budget",
    reason: "HR training and development budget",
    priority: "medium",
    ...
    actionNote: "Approved for employee development initiatives.",
