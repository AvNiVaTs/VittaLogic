          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button asChild size="lg">
                <Link
                  href="/signup"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 text-base rounded-lg flex items-center"
                >
                  START NOW
              ...
              <Button asChild variant="outline" size="lg">
                <Link
                  href="/login"
                  className="px-5 py-3 text-lg border border-blue-600 text-black hover:text-blue-600 hover:bg-blue-50 rounded-lg"
                >
                  Login
                </Link>
              </Button>
