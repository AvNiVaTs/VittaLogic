...
router.route("/createLiability").post(populateCreatedByUpdatedBy, upload.fields([{name: "attachment", maxCount: 1}]), createLiability)
...
router.route("/update/:id").patch(populateCreatedByUpdatedBy, updateLiability)
